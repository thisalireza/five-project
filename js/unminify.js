...
(function(za, O, l) {
    var N = function(h) {
        ...
        p.defaults = {
            ...
            oLanguage: {
                oAria: {
                    sSortAscending: ": برای مرتب سازی ستون صعودی فعال کنید",
                    sSortDescending: ": برای مرتب کردن ستون به صورت نزولی فعال کنید"
                },
                oPaginate: {
                    sFirst: "اولین",
                    sLast: "قبلی",
                ...
                sInfo: "نمایش _START_ تا _END_ از _TOTAL_  کل ورودی ها",
                sInfoEmpty: "نمایش 0 to 0 of 0  کل ورودی ها",
                sInfoFiltered: "(فیلتر شده از _MAX_ کل رکورد ها)",
                sInfoPostFix: "",
                sDecimal: "",
                sThousands: ",",
                sLengthMenu: "نمایش _MENU_ از کل ورودی ها ",
                sLoadingRecords: "در حال لود شدن...",
